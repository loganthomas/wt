...
Pages land alongside the features they document
(standing rule 2 of [PLAN.md](../PLAN.md)):

- [`configuration.md`](configuration.md) — config reference, merge order, detected defaults, state layout
